...
def show_home_page():
    ...
    st.title("Home Page")
    # st.write(f"Welcome, {st.session_state.selected_user}!")
    st.write("This is the home page of The Jager Crew app.")
...
def main():
    ...
    pages = [
        # st.Page(show_home_page, title="Home Page", icon="🏠"),
        st.Page(lambda: show_weekly_winner_page(df_weekly_scores, selected_user), title="Weekly Winner", icon="🏆"),
    ]
