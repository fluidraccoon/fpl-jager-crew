                    ...
                    with st.container(height=100):
                        if is_mobile:
                            st.markdown(
                                ...
                                f"{('✅ ' if stage != 'Final' else '🏆 ') if row['Points 1'] > row['Points 2'] else ''}"
                                f"{row['Points 1']} - {row['Player 1']}<br>"
                                f"{('✅ ' if stage != 'Final' else '🏆 ') if row['Points 2'] > row['Points 1'] else ''}"
                                f"{row['Points 2']} - {row['Player 2']}"
                                f"</div>",
